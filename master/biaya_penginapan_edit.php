...
$sql = "UPDATE tb_penginapan SET propinsi = '$propinsi', satuan = '$satuan', kategori1 = '$kategori1', kategori2 = '$kategori2', kategori3 = '$kategori3', kategori4 = '$kategori4', kategori5 = '$kategori5' WHERE id = '$id_penginapan'";
